...
var meetSnakePedlar = function() {
    ...
    p("&#8220;Snakes for sale!&#8221;");
    p("&#8220;Snakes for sale!&#8221;");
    N("He, too, stopped when he saw the weeping woman. When he asked, she told him all about the Nung Gwama, the other peddlers and the man who offered the manure.");
...
var refuseSnakes = function() {
    ...
    N("She thanked him for his kindness and the peddler went on his way.");
    Wait(2000);
    queue(scene5,0);
};
